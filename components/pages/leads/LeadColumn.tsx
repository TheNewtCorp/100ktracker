...
const LeadColumn = React.forwardRef<HTMLDivElement, LeadColumnProps>(
    ...
    return (
        <div
            ref={ref}
            className="flex-shrink-0 w-72 bg-obsidian-black/50 rounded-xl p-3"
        >
            <h3 className="text-lg font-bold text-champagne-gold mb-4 px-1">{title} <span className="text-platinum-silver/50 font-normal text-base">({leads.length})</span></h3>
            <motion.div 
