...
const LeadCard: React.FC<LeadCardProps> = ({ lead, contact, onClick, onDragEnd, dragConstraints }) => {
    return (
        <motion.div
            layout
            layoutId={lead.id}
        ...
        >
            ...
            <button 
                ...
                className="w-full text-left mt-2 pt-2 border-t border-champagne-gold/10 text-sm text-champagne-gold hover:underline"
            >
                View Details
            </button>
        </motion.div>
